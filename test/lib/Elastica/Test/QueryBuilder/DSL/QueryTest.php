...
class QueryTest extends AbstractDSLTest
{
    ...
    public function testMatch()
    {
        ...
        $this->assertInstanceOf('Elastica\Query\Mtch', $match);
    }
    ...
    public function testInterface()
    {
        ...
        $this->_assertImplemented($queryDSL, 'constant_score', 'Elastica\Query\ConstantScore', array(new Mtch()));
        $this->_assertImplemented($queryDSL, 'dis_max', 'Elastica\Query\DisMax', array());
        $this->_assertImplemented($queryDSL, 'filtered', 'Elastica\Query\Filtered', array(new Mtch(), new Exists('field')));
        ...
        $this->_assertImplemented($queryDSL, 'has_child', 'Elastica\Query\HasChild', array(new Mtch()));
        $this->_assertImplemented($queryDSL, 'has_parent', 'Elastica\Query\HasParent', array(new Mtch(), 'type'));
        $this->_assertImplemented($queryDSL, 'ids', 'Elastica\Query\Ids', array('type', array()));
        $this->_assertImplemented($queryDSL, 'match', 'Elastica\Query\Mtch', array('field', 'values'));
        ...
        $this->_assertImplemented($queryDSL, 'top_children', 'Elastica\Query\TopChildren', array(new Mtch(), 'type'));
